...
> **Status — `0.1.2` preview.** Phases 0–8 are complete: native chat, tool cards, native diff,
...
```sh
npm run vsce:package                       # produces wingman-0.1.2.vsix
code --install-extension wingman-0.1.2.vsix
```
